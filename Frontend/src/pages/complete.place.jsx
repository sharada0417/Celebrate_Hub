      ...
      >
        ...
        <div className="mt-6 border rounded-lg overflow-hidden">
          ...
          <div className="p-4 bg-gray-50">
            ...
            <p className="text-gray-600 mb-2">{data.place.location}</p>
            {data.place.rating && (
              <div className="flex items-center mb-2">
                <span className="text-yellow-500 mr-1">★</span>
                <span>{data.place.rating}</span>
                {data.place.reviews && (
                  <span className="text-gray-500 text-sm ml-1">
                    ({data.place.reviews} reviews)
                  </span>
                )}
              </div>
            )}
          ...
          <div className="bg-gray-50 p-4 rounded-md">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-medium">${data.place.price} per night</p>
              </div>
              <div>
        ...
        <div className="mt-6 border-t pt-4">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Present your booking ID upon arrival at the place</li>
