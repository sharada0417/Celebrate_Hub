...
import { submit } from "@/lib/features/serchSlice";
    ...
    <div className="">
      ...
      <div className="relative z-10 flex flex-col items-center text-white justify-center px-8 pt-32 pb32">
        ...
        <p className="text-xl mb-12 text-center max-w-2xl">
          Describe your dream party destination and experience, and we'll find the perfect place for you
        </p>
        ...
        >
          <Input
            ...
            placeholder="Describe your design, experience, or hotel..."
